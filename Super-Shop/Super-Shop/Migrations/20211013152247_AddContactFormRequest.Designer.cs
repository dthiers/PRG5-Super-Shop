...
namespace Super_Shop.Migrations
{
    ...
    [Migration("20211013152247_AddContactFormRequest")]
    partial class AddContactFormRequest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Super_Shop.Entities.ContactFormRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Super_Shop.Entities.ContactFormRequest", b =>
                {
                    b.HasOne("Super_Shop.Models.Hero", "Hero")
                        .WithMany("ContactFormRequests")
            ...
            modelBuilder.Entity("Super_Shop.Models.Hero", b =>
                {
                    b.Navigation("ContactFormRequests");
                });
